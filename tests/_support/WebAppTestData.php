    ...
    public function getTestData($class) {
        if ($class != null) {
             ...
             break;
              ...
              break;
                ...
                case "Step\Acceptance\ManageFacultyStep": $json = file_get_contents("tests/_data/CoordinatorUserMgmtData.json");
                    break;
                case "Step\Acceptance\CustomSearchStep":
            ...
            case "Step\Acceptance\PermissionStep": $json = file_get_contents("tests/_data/PermissionData.json");
                ...
                case "Step\Acceptance\googleaccountstep": $json = file_get_contents("tests/_data/GoogleData.json");
                    break; 
                case "Step\Api\SystemAlertStepApi": $json = file_get_contents("tests/_data/SystemAlertAPIData.json");
                
                    break;
                case "Step\Acceptance\MyAccountstep": $json = file_get_contents("tests/_data/MyAccountData.json");
    ...
    public function writeTestData($class, $forKey, $value) {
        ...
        switch (get_class($class)) {
           ...
           break;
            ...
            break;
            case "Step\Acceptance\googleaccountstep": file_put_contents("tests/_data/GoogleData.json", json_encode($oldData, JSON_PRETTY_PRINT));
                break;  
           case "Step\Api\SystemAlertStepApi": file_put_contents("tests/_data/SystemAlertAPIData.json", json_encode($oldData, JSON_PRETTY_PRINT));               
                break;
            case "Step\Acceptance\MyAccountstep": file_put_contents("tests/_data/MyAccountData.json", json_encode($oldData, JSON_PRETTY_PRINT));
                break;
        }
