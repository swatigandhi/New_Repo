...
class AcceptanceTester extends \Codeception\Actor {
 ...
 use _generated\AcceptanceTesterActions;
     ...
     /**
     * @Then user is able to see :arg1 message in the alert
     */
    public function userisableToSeeTheInTheAlert($MessageText) {
        $I = $this;
        $I->SuccessMsgAppears($I);
        $I->SuccessMsgTextVerification($I, $MessageText);
        if (strpos($MessageText, "successfully")!==false || strpos($MessageText, "Successfully") !== false||  strpos($MessageText, "submitted")!==false || strpos($MessageText,"office hours series has finished being created")!==false || strpos($MessageText,"Your account has been updated")!==false ) {
    ...
    public function clickOnDeleteDialogBox()
{
 ...
 public function UserclicksOnDeleteButtonDisplayedOnDialogBox(\AcceptanceTester $I) {
    ...
    public function isElementDisplayed(AcceptanceTester $I,$ElementSelectorXpath)
     ...
     public function LoginAsStudent(\AcceptanceTester $I,$studentEmail="autoqa013@mailinator.com",$Password="Qait@123")
    {
             $I->amOnPage("#/login");
...
//             $I->LoginFromEmail($I,$username);
    ...
    $I->wait(2);
    $I->click("//button[contains(text(),'student')]");
    $I->WaitForPageToLoad($I);
